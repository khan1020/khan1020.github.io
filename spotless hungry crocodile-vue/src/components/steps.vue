      ...
      <div class="steps-container2 thq-grid-2">
        <div class="steps-section-header">
          ...
          <div class="steps-actions">
            <button class="thq-button-filled thq-button-animated steps-button">
...
export default {
  ...
  props: {
    ...
    step3Title: {
      type: String,
      default: 'Book Appointments',
    },
    step4Title: {
      type: String,
      default: 'Manage Your Health Records',
    },
    step1Title: {
      type: String,
    ...
    step2Title: {
      type: String,
      default: 'Search for Healthcare Providers',
    },
    step3Description: {
      type: String,
      default:
