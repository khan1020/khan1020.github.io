...
export default {
  ...
  props: {
    ...
    plan3Feature2: {
      type: String,
      default: 'Priority access to specialists',
    },
    plan3Yearly1: {
      type: String,
    ...
    plan1Feature1: {
      type: String,
      default: 'Access to basic health monitoring tools',
    },
    plan1Price: {
      type: String,
      default: '$29.99/month',
    ...
    plan3Feature3: {
      type: String,
      default: 'Advanced health analytics',
    },
    plan2Action: {
      type: String,
      default: 'Sign Up Now',
    ...
    plan3Feature1: {
      type: String,
      default: 'All features of Standard Plan',
    },
    plan3Feature11: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan2Feature3: {
      type: String,
      default: 'Health data encryption',
    },
    plan11: {
      type: String,
      default: 'Basic plan',
    ...
    plan1Feature3: {
      type: String,
      default: 'Monthly health reports',
    },
    plan2Feature1: {
      type: String,
      default: 'All features of Basic Plan',
    },
    plan3Feature5: {
      type: String,
      default: 'Feature text goes here',
    ...
    plan2Feature2: {
      type: String,
      default: 'Personalized health recommendations',
    },
  },
  data() {
    return {
